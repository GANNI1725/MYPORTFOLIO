...
export default function ThemeToggle() {
  ...
  return (
    <motion.button
      ...
      className="relative w-8 h-8 rounded-full outline-none focus-visible:ring-2 focus-visible:ring-accent/50 focus-visible:ring-offset-2 focus-visible:ring-offset-canvas flex items-center justify-center"
    >
      <motion.div
